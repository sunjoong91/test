...
public class korean_level2 extends JFrame {
	// 말 위치
	private int chrX = 0;
	private int chrY = 0;
	...
	public korean_level2() {
		...
		getWordList = miro.getWordList(2,4); //오답수 3개, 정답수 1
		...
		String sql = "select seq from TB_EDU_DATA WHERE LEVEL = 2 AND TYPE = 1";
