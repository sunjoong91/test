...
public class english_level5 extends JFrame{
	...
	public english_level5() {
		...
		getWordList = miro.getWordList(5,7);//7개 단어 뿌려지는 칸
		...
		String sql = "select seq from TB_EDU_DATA WHERE LEVEL = 5 AND TYPE = 2";
		...
		Util util = new Util();
		Map<String,Object> map = util.randomWordCutEng(word, blankCnt);//단어, blank 단어갯수 
