...
import gui.math_level1.MyKeyListener;
import miro.Miro;
import util.UtilMath;

public class math_level2 extends JFrame {
	// 말 위치
	private int chrX = 0;
	private int chrY = 0;
	 ...
	 * Create the frame.
	 */
	public math_level2() throws Exception{
		setTitle("Math");
		...
		getWordList = miro.getWordList(2,4); //정답수1, 오답수 3
		...
		String sql = "select seq from TB_EDU_DATA WHERE LEVEL = 2 AND TYPE = 3";
