...
public class korean_level1 extends JFrame {
	...
	public korean_level1() {
		...
		getWordList = miro.getWordList(1,3);//오답수 2, 정답수 1
		...
		String sql = "select seq from TB_EDU_DATA WHERE LEVEL = 1 AND TYPE = 1"; //국어 레벨1 타입1
		...
		Map<String,Object> map = utilKor.level1Info(word);
