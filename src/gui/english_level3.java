...
import gui.english_level2.MyKeyListener;
import miro.Miro;

public class english_level3 extends JFrame {
	// 말 위치
	private int chrX = 0;
	private int chrY = 0;
	...
	public english_level3() {
		...
		getWordList = miro.getWordList(3,5);//6개 단어 뿌려지는 칸
		...
		String sql = "select seq from TB_EDU_DATA WHERE LEVEL = 3 AND TYPE = 2";
