...
import gui.korean_level5.MyKeyListener;
import miro.Miro;
import util.UtilKor;

public class korean_level5 extends JFrame {
	// 말 위치
	private int chrX = 0;
	private int chrY = 0;
	...
	public korean_level5() {
		...
		getWordList = miro.getWordList(5,5);//7개 단어 뿌려지는 칸
		...
		String sql = "select seq from TB_EDU_DATA WHERE LEVEL = 5 AND TYPE = 1";
...
//						repaint();
	...
	public void paint(Graphics g) {
		...
		//미로 단어 font
		Font font = new Font("font", Font.BOLD, 35);
		//단어 font
