...
public class korean_level3 extends JFrame {
	// 말 위치
	private int chrX = 0;
	private int chrY = 0;
	...
	public korean_level3() {
		...
		getWordList = miro.getWordList(3,4);//오답 3개, 정답 1개
		...
		String sql = "select seq from TB_EDU_DATA WHERE LEVEL = 3 AND TYPE = 1";
		...
		String types[] = {"3","4"};//받침있는 단모음 :3,  받침있는 이중모음:4
